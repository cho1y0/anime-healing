...
"""
      ...
      # 프롬프트 다이어트: 생성해야 할 글자 수를 대폭 줄여서 속도를 끌어올립니다.
        prompt = f"""당신은 애니메이션 추천 전문가입니다.
빠른 응답 속도가 생명이니, 아래 애니메이션들에 대해 최대한 짧고 간결하게 세 가지 작업을 해주세요:
1. 코멘트: 작품당 딱 1문장으로 핵심만 짚은 매력적인 추천사
2. 줄거리: 영어 줄거리를 한국어로 딱 1~2문장으로 초간단 요약
3. 제목: 공식 한국어 제목 또는 자연스러운 번역

반드시 아래 JSON 형식으로만 응답하세요. 마크다운이나 다른 설명은 절대 추가하지 마세요.
{{"comments": ["1번 코멘트", ...], "synopses": ["1번 줄거리", ...], "titles_kr": ["1번 제목", ...]}}
